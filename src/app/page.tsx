            ...
            <div className="md:w-1/3 pr-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 space-y-6 mt-8">
                ...
                <div className="flex flex-row space-x-4 justify-center">
                  ...
                  <a 
                    href="/Wei_Hsin_Yen_Resume_0212.pdf"
                    download
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <span className="px-3 py-1 bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-100 rounded-full text-sm">JavaScript</span>
                        </div>
                      </div>
                      <div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <span className="px-3 py-1 bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-100 rounded-full text-sm">MySQL</span>
